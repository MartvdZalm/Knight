...
// {
// 	private Hashtable<String, SClass> hashtable; // Hashtable to store classes with their identifiers as keys
...
// 			return false;
// 		} else {
// 			hashtable.put(id, new SClass(id, parent));
// 		}
// 		return true;
// 	}
...
//      */
// 	public SClass getKlass(String id)
// 	{
// 		if (containsKlass(id)) {
...
//      */
	// public SVariable getVar(SFunction m, SClass c, String id)
	// {
	// 	if (m != null) {
	// 		if (m.getVar(id) != null) {
	// 			return m.getVar(id);
...
//      */
// 	public boolean containsVar(SFunction m, SClass c, String id)
// 	{
// 		SVariable var = getVar(m, c, id);
// 		if (var != null) {
// 			return true;
// 		}
// 		return false;
...
//      */
// 	public Type getVarType(SFunction m, SClass c, String id)
// 	{
// 		SVariable var = getVar(m, c, id);
// 		if (var != null) {
// 			return var.getType();
