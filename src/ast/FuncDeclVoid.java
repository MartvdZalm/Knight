...
public class FuncDeclVoid extends FuncDecl
{
	...
	public FuncDeclVoid(Token token, Type returnType, IdentifierExpr methodName, List<ArgDecl> argList, List<Declaration> varList, List<Statement> statList, Token access)
	{
		super(token);
