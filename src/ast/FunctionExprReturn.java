...
public class FunctionExprReturn extends Expression
{
	...
	public FunctionExprReturn(Token token, List<ArgDecl> argList, List<Declaration> varList, List<Statement> statList, Expression returnExpr)
	{
		super(token);
