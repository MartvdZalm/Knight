...
public class FuncDeclStandardReturn extends FuncDecl
{
	...
	public FuncDeclStandardReturn(Token token, Type returnType, IdentifierExpr methodName, List<ArgDecl> argList, List<Declaration> varList, List<Statement> statList, Expression returnExpr, Token access)
	{
		super(token);
