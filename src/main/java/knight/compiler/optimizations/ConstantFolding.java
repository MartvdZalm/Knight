...
public class ConstantFolding implements ASTVisitor<ASTExpression>
{
	...
	public ASTExpression visit(ASTReturnStatement astReturnStatement)
	{
		if (astReturnStatement.getExpression() != null) {
			astReturnStatement.setExpression(astReturnStatement.getExpression().accept(this));
		}
		return null;
	}
	...
	@Override
	public ASTExpression visit(ASTFieldAccessExpr astFieldAccessExpr)
	{
		return astFieldAccessExpr;
	}
}
