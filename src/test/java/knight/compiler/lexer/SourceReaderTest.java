...
public class SourceReaderTest
{
	...
	// @Test
	// public void mark_and_reset_should_restore_previous_position() throws
	// IOException
	// {
	...
	// @Test
	// public void reset_without_mark_should_throw_IllegalStateException() throws
	// IOException
	// {
	...
	// @ParameterizedTest
	// @CsvSource({ "'ABC\nDEF', 'A,B,C,D,E,F'", "'X\nY\nZ', 'X,Y,Z'" })
	// public void read_should_return_correct_characters(String input, String
	...
	// @Test
	// public void read_after_close_should_throw_IllegalStateException() throws
	// IOException
	// {
	// BufferedReader bufferedReader = new BufferedReader(new StringReader("test"));
	// sourceReader = new SourceReader(bufferedReader);
	...
	// @Test
	// public void
	// mark_when_unsupported_should_throw_UnsupportedOperationException()
	// {
	...
	// @Test
	// public void
	// reset_when_unsupported_should_throw_UnsupportedOperationException()
	// {
	// when(mockReader.markSupported()).thenReturn(false);
	// sourceReader = new SourceReader(mockReader);
	// assertThrows(UnsupportedOperationException.class, () ->
