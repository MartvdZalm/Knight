...
public class LexerTest extends TestUtils
{
	...
	public void testNextTokenKnightVariables()
	{
		BufferedReader bufferedReader = new BufferedReader(
				new StringReader("int age = 18; string name = \"Mart van der Zalm\"; bool adult = true;"));
		Lexer lexer = new Lexer(bufferedReader);
	...
	{
		BufferedReader bufferedReader = new BufferedReader(new StringReader(
				"class Person { int age = 18; string name = \"Mart van der Zalm\"; fn getName(): string { ret name; } }"));
		Lexer lexer = new Lexer(bufferedReader);
