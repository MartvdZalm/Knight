...
public class FuncDecl extends Tree
{
	...
	public FuncDecl(Token token, Type returnType, IdentifierExpr methodName, List<ArgDecl> argList, List<VarDecl> varList, List<Statement> statList, Expression returnExpr)
	{
		super(token);
